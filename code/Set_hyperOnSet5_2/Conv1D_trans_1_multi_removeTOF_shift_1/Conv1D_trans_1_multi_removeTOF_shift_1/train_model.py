...
def train(args, epoch_start, state):
    if epoch_start > 0:
        ...
        params =  {'L2_reguralization': 0.0001,
 'activation': 'relu',
 'alpha': 0.7,
 'amplitude_shift': 0.4,
 'batch_size': 16,
 'conv_layer_1_batchnorm': {'name': True},
 'conv_layer_1_channels_out': 128,
 'conv_layer_1_extras': 'name',
 'conv_layer_1_kernel_size': 4,
 'conv_layer_1_kernel_size_maxpool': 3,
 'conv_layer_1_strides': 1,
 'conv_layer_1_strides_maxpool': 1,
 'conv_layer_2_batchnorm': {'name': True},
 'conv_layer_2_channels_out': 8,
 ...
 'conv_layer_3_batchnorm': {'name': True},
 'conv_layer_3_channels_out': 64,
 ...
 'conv_layer_7_channels_out': 128,
 'conv_layer_7_extras': 'name',
 'conv_layer_7_kernel_size': 2,
 'conv_layer_7_kernel_size_maxpool': 3,
 'conv_layer_7_strides': 1,
 'conv_layer_7_strides_maxpool': 1,
 'conv_layer_8_batchnorm': {'name': True},
 'conv_layer_8_channels_out': 256,
 'conv_layer_8_extras': 'name',
 'conv_layer_8_kernel_size': 4,
 'conv_layer_8_kernel_size_maxpool': 3,
 'conv_layer_8_strides': 1,
 'conv_layer_8_strides_maxpool': 2,
 'conv_layer_9_batchnorm': {'name': True},
 'conv_layer_9_channels_out': 2,
 'conv_layer_9_extras': 'name',
 'conv_layer_9_kernel_size': 2,
 'conv_layer_9_kernel_size_maxpool': 2,
 'conv_layer_9_strides': 1,
 'conv_layer_9_strides_maxpool': 2,
 'conv_order': True,
 'fc_layer_1_batchnorm': {'name': False},
 'fc_layer_1_extras': {'name': 'dropout', 'rate': 0.4490915612887155},
 'fc_layer_2_batchnorm': {'name': False},
 ...
 'fc_layer_5_extras': {'name': 'dropout', 'rate': 0.6145277973319153},
 'fc_layer_6_batchnorm': {'name': True},
 'fc_layer_6_extras': {'name': 'dropout', 'rate': 0.6231936986126585},
 'fc_layer_7_batchnorm': {'name': True},
 'fc_layer_7_extras': {'name': 'dropout', 'rate': 0.5366566704227451},
 'fc_layer_8_batchnorm': {'name': False},
